...
## Project Structure
    ...
    ├── the_groom_room_reso_37007  # Django project configurations
...
1. Clone this repo and `cd the_groom_room_reso_37007`
...
2. Clone this repo and `cd the_groom_room_reso_37007`
